...
#Arranque para el mac.. para tener actualizados todos los gits
#Queda guardado en /Users/juan.nouche/desktop/actualizar.sh
...
git pull
cd /Volumes/ALMACEN1TB/proyectos_python/tablesdir
git pull
